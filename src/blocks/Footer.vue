        ...
        <footer>
            <div class="container footerSet">
                <div class="footerSet__leftModule">
                    ...
                    <div class="footerSet__text">
                        It is a long established fact that a reader will be distracted lookings.
                    </div>
                    <div class="footerSet__logoBar">
                ...
                <nav class="footerSet__middleModule">
                    ...
                    <router-link to="/">
                        <div class="footerSet__text">Home</div>
                    </router-link>
                    <router-link to="/OurProjects">
                        <div class="footerSet__text">Project</div>
                    </router-link>
                    <router-link to="/Blog">
                        <div class="footerSet__text">Blog</div>
                    </router-link>
                </nav>
                <div class="footerSet__rightModule">
                    <div class="footerSet__heading">Contact</div>
                    <div class="footerSet__text">55 East Birchwood Ave. Brooklyn, New York 11201</div>
                    <div class="footerSet__text">contact@interno.com</div>
                    <div class="footerSet__text">(123) 456 - 7890</div>
                </div>
            </div>
        </footer>
